...
$msg=mysqli_query($con,"update users set fname='$fname',lname='$lname',contactno='$contact',gender='$gender',
dob='$dob',blood_group='$blood_group'
where id='$userid'");
                     ...
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                    <th>Date of Birth</th>
                                       <td><input class="form-control" id="dob" name="dob" type="text" value="<?php echo $result['dob'];?>" required /></td>
                                   </tr>
                                   <tr>
                                    <th>Gender</th>
