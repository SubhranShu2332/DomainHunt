...
if(isset($_POST['update']))
{
    ...
    $dob=$_POST["dob"];
    $msg=mysqli_query($con,"update users set fname='$fname',lname='$lname',contactno='$contact',
    dob='$dob'
    where id='$userid'");
                     ...
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <th>Date of Birth</th>
                                       <td colspan="3"><input class="form-control" id="dob" name="dob" type="text" value="<?php echo $result['dob'];?>" required /></td>
                                   </tr>
                                   
                                   <tr>
                                       <th>Tech Domain</th>
                                       <td colspan="3"><?php echo $result['tech_domain'];?></td>
                                   </tr>
                                   <tr>
                                       <th>Tech Stack</th>
                                       <td colspan="3"><?php echo $result['tech_stack'];?></td>
                                   </tr>
